...
async def startClient():
    ...
    try:
        ...
        if(e.__class__.__name__ == "LoginFailure"):
                print("Something went wrong with the token. If this is the first time you use this bot, please go to http://localhost:5557 and edit your preferences.")
        else:
            print(e)
